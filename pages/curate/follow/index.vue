<template>
    ...
    <ItemFollowModel></ItemFollowModel>
...
import ItemFollowModel from "@/components/Item/ItemFollowModel";
...
export default {
  ...
  computed: {
    ...
    async asyncData({ store }) {
        ...
        localStorage.getItem("previousPage")=="model-id"){
            ...
            store.dispatch("setFollowOption","follow");
  ...
  beforeRouteLeave(to, from, next) {
    if(to.name == "model-id"||
        ...
        this.$store.dispatch("setFollowOption","");
    }
